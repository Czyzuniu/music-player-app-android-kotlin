package com.example.spotifyclone.core.designsystem.components.atoms
...
@Composable
fun Heading(text: String, headingType: HeadingType, modifier: Modifier = Modifier) {
    Text(
        text,
...
fun HeadingPreview() {
    Heading(
        ...
        headingType = HeadingType.TitleTwo
    )
}